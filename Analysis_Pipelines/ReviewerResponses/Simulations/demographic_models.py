...
def _papuans500_10j19():
    id = "Papuans500OutOfAfrica_10J19"
    description = "Out-of-Africa with archaic admixture into Papuans and Nb_Papua=500"
    long_description = """
        A ten population model of out-of-Africa, including two pulses of
        Denisovan admixture into Papuans, and several pulses of Neandertal
        admixture into non-Africans.
        ...
        This model is an extension of one from Malaspinas et al. (2016), thus
        some parameters are inherited from there.
        This model has been tweaked slightly so that the size of the Papuan
        population bottleneck after splitting is 500 instead of 243.
        """
...
_species.add_demographic_model(_papuans500_10j19())

def _papuans1k_10j19():
    id = "Papuans1kOutOfAfrica_10J19"
    description = "Out-of-Africa with archaic admixture into Papuans and Nb_Papua=1000"
    long_description = """
        A ten population model of out-of-Africa, including two pulses of
        Denisovan admixture into Papuans, and several pulses of Neandertal
        admixture into non-Africans.
        ...
        some parameters are inherited from there.
        This model has been tweaked slightly so that the size of the Papuan
        population bottleneck after splitting is 1000 instead of 243.
        """
...
_species.add_demographic_model(_papuans1k_10j19())
